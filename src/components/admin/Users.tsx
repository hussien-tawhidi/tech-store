      ...
      <table className='w-full border-collaps text-left text-sm text-gray-500'>
        ...
        <tbody className='dark:divide-gray-400'>
          <tr className='hover:bg-gray-50 dark:hover:bg-gray-600 cursor-pointer shadow-md dark:shadow-gray-600'>
            ...
            <td className='px-6 py-4 dark:text-gray-400'>Product Designer</td>
            <td className='px-6 py-4'>
              <div className='flex gap-2'>
                ...
                <span className='inline-flex items-center gap-1 rounded-full bg-indigo-50 px-2 py-1 text-xs font-semibold text-red-500 dark:hover:text-red-700 transition-all hover:text-red-600 dark:bg-blue-50'>
                  Update
                </span>
                <span className='inline-flex items-center gap-1 rounded-full bg-violet-50 px-2 py-1 text-xs font-semibold text-red-500 dark:hover:text-red-700 transition-all hover:text-red-600 dark:bg-blue-50'>
                  Delete
                </span>
              </div>
            </td>
