  ...
  return (
    <div className='p-2 relative'>
      <div className='flex justify-center items-center lg:gap-5 gap-3'>
        <Link
          href='/'
          className={`text-slate-600 dark:text-slate-300 capitalize text-sm animate__animated animate__fadeInUp hover:text-sky-950 transition-all hover:border-b hover:border-slate-500 dark:hover:text-slate-50 ${
            pathname === "/" &&
