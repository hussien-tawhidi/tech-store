  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setFormData({ name: "", email: "", message: "", title: "", phone: "" });
      } else {
        toast.error(data.message + "Something went wrong try again");
        console.log(data.message);
      }
    } catch (error) {
      console.log(error, "in contactform");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className='container my-12 mx-auto px-2 md:px-4'>
      <section className='mb-32'>
        ...
        <div className='flex flex-wrap'>
          <form
            className='mb-12 w-full flex flex-col gap-3 shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6'
            onSubmit={handleSubmit}>
            <p className='h-1 font-bold text-slate-600 mb-5b text-3xl'>
              Text us if you want to say somthing
            </p>
            <TextInput
              ...
              <div className='mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6'>
                <div className='flex items-start'>
                  <div className='shrink-0'>
                    <div className='inline-block rounded-md bg-slate-400-100 p-4 text-slate-700'>
                      <svg
